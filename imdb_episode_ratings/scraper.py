...
def get_new_url( soup_object ): 
	...
	show_final = next(
	    (show for show in list_queries if "(TV Series)" in show.text), None)
	...
	return f"https://www.imdb.com/{url_change}episodes?season=" 
